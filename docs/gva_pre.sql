...
INSERT INTO `ad_platform` (`id`, `uuid`, `created_at`, `updated_at`, `deleted_at`, `platform_key`, `name`, `status`, `remark`) VALUES (6, '4f53b2a2-e6cd-40df-b3f9-50f0ef9a297b', '2026-03-20 23:48:32.319', '2026-03-20 23:48:32.319', NULL, 'UC(超级汇川)', 'UC(超级汇川)', 1, '');
