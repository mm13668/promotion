...
func (r *RegionRouter) InitRegionRouter(Router *gin.RouterGroup) {
	group := Router.Group("promotion").Use(middleware.OperationRecord())
	{
		...
		group.GET("getQAAnswerDetail/:id", promoApi.QAApi.GetAnswerDetail)
		group.POST("batchUpdateAnswerSort", promoApi.QAApi.BatchUpdateAnswerSort)
		group.POST("batchUpdateReplySort", promoApi.QAApi.BatchUpdateReplySort)
