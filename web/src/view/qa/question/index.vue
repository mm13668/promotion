...
import { getQAQuestionList, createQAQuestion, updateQAQuestion, deleteQAQuestion } from '@/api/promotion'
...
const form = ref({ ID: 0, title: '', content: '', status: 1, sort: 0 })
const openForm = (row) => { form.value = row ? { ...row } : { ID: 0, title: '', content: '', status: 1, sort: 0 }; drawer.value = true }
const submit = async () => {
